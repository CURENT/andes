...
class VSC2(DCBase):
    ...
    def gcall(self, dae):
        # 1
        dae.g[self.vd] = mul(self.u, dae.y[self.v], cos(dae.y[self.a] - dae.x[self.adq])) - dae.y[self.vd]

        # 2
        dae.g[self.vq] = mul(self.u, dae.y[self.v], sin(dae.y[self.a] - dae.x[self.adq])) - dae.y[self.vq]

...
file_classes = list([
    ...
    ('pss', ['IEEEST', 'ST2CUT']),
    ('motor', ['Motor3', 'Motor5']),
    ('measurement', ['BusFreq', 'BusROCOF', 'PMU', 'PLL1', 'PLL2', 'InertiaEstimationLiu', 'InertiaEstimationLiuWashout', 'InertiaEstimationConstantPm', 'InertiaEstimationVariablePm', 'InertiaEstimationConstPmREGCA1', 'InertiaEstimationConstPmREGCV2', ]),

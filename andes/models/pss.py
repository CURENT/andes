...
class PSS2(ModelBase):
    ...
    def servcall(self, dae):
        self.copy_data_ext('AVR', 'syn', 'syn', self.avr, astype=list)
        self.copy_data_ext('AVR', 'u', 'uavr', self.avr, astype=matrix)
        self.copy_data_ext('Synchronous', 'bus', 'bus', self.syn)
        self.copy_data_ext('Synchronous', 'u', 'usyn', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'Sn', 'Sg', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'omega', 'omega', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'v', 'v', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'p', 'p', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'pm', 'pm', self.syn, astype=matrix)
        self.copy_data_ext('Synchronous', 'vf', 'vf', self.syn, astype=matrix)
        self.copy_data_ext('BusFreq', 'w', 'w', self.bus, astype=matrix)

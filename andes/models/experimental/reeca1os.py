...
class REECA1OSData(ModelData):
    """
    Renewable energy electrical control model REECA1OS (reec_a with operator
    splitting) data.
    """
...
class REECA1OSModel(Model):
    """
    REEC_A model with operator splitting implementation.
    """
...
class REECA1OS(REECA1OSData, REECA1OSModel):
    """
    Renewable energy electrical control implemented with operator splitting.

...
class LineNew(LineData, Model):
    def __init__(self, system=None, name=None):
        ...
        self.a2 = ExtAlgeb(model='BusNew', src='a', indexer=self.bus2)
        self.v1 = ExtAlgeb(model='BusNew', src='v', indexer=self.bus1)
        self.v2 = ExtAlgeb(model='BusNew', src='v', indexer=self.bus2)

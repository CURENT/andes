...
WTG3, idx = 1, bus = 8, wind = 1, Sn = 2458, Vn = 20, fn = 60, rs = 0, xs = 0.08, rr = 0, xr = 0.08, xmu = 1, Hm = 4.95,
      gen = 3, Kp = 150, Tp = 0.3, Kv = 18, Te = 0.05, R = 75, npole = 4, nb = 3, ngb = 0.01123596,
      pmax = 1.12, pmin = 0.04, qmax = 0.436, qmin = -0.436, u = 1

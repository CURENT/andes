...
R, idx = "R_COI_1", name = "R Celilo-Sylmarla P", node1 = "Node_COI_1", node2 = "Node_COI_2",
     Vdcn = 193.0, R = 1
R, idx = "R_COI_2", name = "R Celilo-Sylmarla N", node1 = "Node_COI_3", node2 = "Node_COI_4",
     Vdcn = -193.0, R = 1


C, idx = "C_COI_1", name = "C Celilo P", node1 = "Node_COI_1", node2 = "Node_COI_0", Vdcn = 193.0, C = 50
C, idx = "C_COI_2", name = "C Sylmarla P", node1 = "Node_COI_2", node2 = "Node_COI_0", Vdcn = 193.0, C = 50

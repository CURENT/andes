...
Bus, Vn = 20.0, angle = 0.35029, area = 1.0, idx = 1, name = "GEN G1", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 1.03, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 20.0, angle = 0.17987, area = 1.0, idx = 2, name = "GEN G2", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 1.01, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 20.0, angle = -0.12217, area = 2.0, idx = 3, name = "GEN G3", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 1.03, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 20.0, angle = -0.30006, area = 2.0, idx = 4, name = "GEN G4", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 1.01, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = 0.23751, area = 1.0, idx = 5, name = "G1", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 1.00646, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = 0.0615, area = 1.0, idx = 6, name = "G2", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 0.97813, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = -0.08527, area = 1.0, idx = 7, name = "LOAD A", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 0.96102, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = -0.32734, area = 1.0, idx = 8, name = "MID POINT", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 0.94862, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = -0.56465, area = 2.0, idx = 9, name = "LOAD B", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 0.97137, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = -0.41778, area = 2.0, idx = 10, name = "G4", owner = 0, region = 1.0,
     u = 1, vmax = 1.1, vmin = 0.9, voltage = 0.98346, xcoord = 0, ycoord = 0, zone = 0
Bus, Vn = 230.0, angle = -0.23784, area = 2.0, idx = 11, name = "G3", owner = 0, region = 1.0,

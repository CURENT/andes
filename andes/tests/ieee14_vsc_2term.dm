...
VSC, idx = 1, node1 = 1, node2 = 0, bus = 1, Vn = 1, name = "VSC 1", rsh = 0.0025, xsh = 0.5,
     vshmax = 999, vshmin = 0, Ishmax = 999, vref0 = 1.06, vdcref0 = 1.0, control = "vV",
     Vdcn = 100, u = 1
VSC, idx = 2, node1 = 2, node2 = 0, bus = 2, Vn = 1, name = "VSC 2", rsh = 0.0025, xsh = 0.06,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = -0.15, qref0 = -0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.99, Vdcn = 100, u = 1
VSC, idx = 3, node1 = 3, node2 = 0, bus = 13, Vn = 1, name = "VSC 3", rsh = 0.0025, xsh = 0.06,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = 0.1, qref0 = 0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.995, Vdcn = 100, u = 1
VSC, idx = 4, node1 = 4, node2 = 0, bus = 14, Vn = 1, name = "VSC 4", rsh = 0.0025, xsh = 0.06,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = 0.1, qref0 = 0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.995, Vdcn = 100, u = 1

VSC1, vsc = 1, name = "VSC 1", Kp1 = 0.2, Ki1 = 1, Kp2 = 4, Ki2 = 2,
      Kp3 = 1, Ki3 = 0.5
VSC2A, vsc = 2, name = "VSC 2", Kp1 = 0.2, Ki1 = 0.1, Kp2 = 0.2, Ki2 = 0.01,
      Kp3 = -0.1, Ki3 = -0.001, D = -10, M = -10, KQ = 0
VSC2A, vsc = 3, name = "VSC 3", Kp1 = 0.2, Ki1 = 1, Kp2 = 0.2, Ki2 = 0.01,

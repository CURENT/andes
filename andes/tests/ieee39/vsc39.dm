...
VSC, idx = 1, node1 = 1, node2 = 0, bus = 10, Vn = 1, name = "VSC 1", rsh = 0.0025, xsh = 0.2,
     vshmax = 999, vshmin = 0, Ishmax = 999, vref0 = 1.04, vdcref0 = 1.0, control = "vV",
     Vdcn = 100, u = 1
VSC, idx = 2, node1 = 2, node2 = 0, bus = 30, Vn = 1, name = "VSC 2", rsh = 0.0025, xsh = 0.2,
...
VSC1, vsc = 1, name = "VSC 1", Kp1 = 1, Ki1 = 0.2, Kp2 = 4, Ki2 = 2,
      Kp3 = 1, Ki3 = 2
VSC2B, vsc = 2, name = "VSC 2", Kp1 = 0.1, Ki1 = 0.1, Kp2 = 0.2, Ki2 = 0.1,
      Kp3 = 0.05, Ki3 = 0.1, D = 10, M = 10, KQ = 0
VSC2B, vsc = 3, name = "VSC 3", Kp1 = 0.1, Ki1 = 0.01, Kp2 = 0.2, Ki2 = 0.01,
      Kp3 = 0.05, Ki3 = 0.001, D = 0.2, M = 3, KQ = 0.2
VSC2B, vsc = 4, name = "VSC 4", Kp1 = 0.1, Ki1 = 1, Kp2 = 0.2, Ki2 = 0.0,
      Kp3 = 0.05, Ki3 = 0.001, D = 2, M = 5, KQ = 0.2

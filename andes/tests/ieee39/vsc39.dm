...
VSC, idx = 1, node1 = 1, node2 = 0, bus = 30, Vn = 1, name = "VSC 1", rsh = 0.0025, xsh = 0.4,
     vshmax = 999, vshmin = 0, Ishmax = 999, vref0 = 1.05, vdcref0 = 1.0, control = "vV",
     Vdcn = 100, u = 1
VSC, idx = 2, node1 = 2, node2 = 0, bus = 35, Vn = 1, name = "VSC 2", rsh = 0.0025, xsh = 0.4,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = -1.2, qref0 = -0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.99, Vdcn = 100, u = 1
VSC, idx = 3, node1 = 3, node2 = 0, bus = 8, Vn = 1, name = "VSC 3", rsh = 0.0025, xsh = 0.4,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = 0.6, qref0 = 0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.995, Vdcn = 100, u = 1
VSC, idx = 4, node1 = 4, node2 = 0, bus = 16, Vn = 1, name = "VSC 4", rsh = 0.0025, xsh = 0.4,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = 0.8, qref0 = 0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.995, Vdcn = 100, u = 1

VSC1, vsc = 1, name = "VSC 1", Kp1 = 0.5, Ki1 = 0.05, Kp2 = 4, Ki2 = 1,
      Kp3 = 1, Ki3 = 1
VSC2B, vsc = 2, name = "VSC 2", Kp1 = 0.1, Ki1 = 0.05, Kp2 = 0.5, Ki2 = 0.01,
      Kp3 = 0.6, Ki3 = 0.05, D = 4, M = 4, KQ = 0
VSC2B, vsc = 3, name = "VSC 3", Kp1 = 0.08, Ki1 = 0.0, Kp2 = 0.04, Ki2 = 0.00,
      Kp3 = 0.02, Ki3 = 0.00, D = 10, M = 4
VSC2B, vsc = 4, name = "VSC 4", Kp1 = 0.08, Ki1 = 0.04, Kp2 = 0.2, Ki2 = 0.001,
      Kp3 = 0.02, Ki3 = 0.00, D = 10, M = 4

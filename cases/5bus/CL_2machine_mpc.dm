...
VSC1, vsc = 2, name = "VSC 2", Kp1 = 0.2, Ki1 = 0.1, Kp2 = 0.2, Ki2 = 0.0,
      Kp3 = 0.01, Ki3 = 0.0
...
# AGCSynVSC, idx = 1, name = "AGC 1", BArea = 1, syn = [1], Ki = 0.5, vsc = [1], Rvsc = [0.02]
# AGCSynVSC, idx = 2, name = "AGC 2", BArea = 2, syn = [2], Ki = 0.5, vsc = [2], Rvsc = [0.02]
...
# LoadScale, group="StaticLoad", load="PQ load_1", scale=1.02, t1=1
# LoadScale, group="StaticLoad", load="PQ load_1", scale=1.02, t1=2
# LoadScale, group="StaticLoad", load="PQ load_1", scale=1.02, t1=3
# LoadScale, group="StaticLoad", load="PQ load_1", scale=1.02, t1=4
# LoadScale, group="StaticLoad", load="PQ load_1", scale=1.02, t1=5
LoadScale, group="StaticLoad", load="PQ load_1", inc=0.02, t1=10
LoadScale, group="StaticLoad", load="PQ load_1", inc=0.02, t1=60
LoadScale, group="StaticLoad", load="PQ load_1", inc=0.02, t1=110
LoadScale, group="StaticLoad", load="PQ load_1", inc=0.02, t1=160

# LoadScale, group="StaticLoad", load="PQ load_1", scale=0.98, t1=12
# LoadScale, group="StaticLoad", load="PQ load_1", scale=0.98, t1=13
# LoadScale, group="StaticLoad", load="PQ load_1", scale=0.98, t1=14
# LoadScale, group="StaticLoad", load="PQ load_1", scale=0.98, t1=15

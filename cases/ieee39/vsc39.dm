# This case works for the VSC1 and VSC2B cases in event of generator 8 trip
# The dc current equation won't satisfy when an ac fault happens on the bus of VSC_1
...
VSC, idx = 1, node1 = 1, node2 = 0, bus = 29, Vn = 1, name = "VSC 1", rsh = 0.0025, xsh = 0.5,
     vshmax = 999, vshmin = 0, Ishmax = 999, vref0 = 1.05, vdcref0 = 1.0, control = "vV",
     Vdcn = 100, u = 1
VSC, idx = 2, node1 = 2, node2 = 0, bus = 22, Vn = 1, name = "VSC 2", rsh = 0.0025, xsh = 0.1,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = -1.5, qref0 = -0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.99, Vdcn = 100, u = 1
VSC, idx = 3, node1 = 3, node2 = 0, bus = 6, Vn = 1, name = "VSC 3", rsh = 0.0025, xsh = 0.1,
     vshmax = 999, vshmin = 0, Ishmax = 999, pref0 = 1.5, qref0 = 0.00, control = "PQ",
     droop = 0, K = -0.5, vhigh = 1.01, vlow = 0.995, Vdcn = 100, u = 1
VSC, idx = 4, node1 = 4, node2 = 0, bus = 26, Vn = 1, name = "VSC 4", rsh = 0.0025, xsh = 0.1,
...
RLs, idx = "RLs4", name = "RLs 1-3", node1 = 1, node2 = 4, Vdcn = 100, R = 0.1, L = 0.001
